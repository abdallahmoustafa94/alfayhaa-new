export const API_ENDPOINTS = {
  ...
  product1: '/product-1.json',
  product2: '/product-2.json',
  product3: '/product-3.json',
  product4: '/product-4.json',
  product5: '/product-5.json',
  product6: '/product-6.json',
  product7: '/product-7.json',
  product8: '/product-8.json',
  product9: '/product-9.json',
