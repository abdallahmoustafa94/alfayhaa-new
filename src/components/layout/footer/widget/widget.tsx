      ...
      <div className="grid grid-cols-2 md:grid-cols-12 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 pb-[50px]">
        ...
        {widgets?.map((widget) => (
          <WidgetLink
            ...
            data={widget}
            className="pb-3.5 sm:pb-0 col-span-4 md:col-span-4 text-center"
          />
        ))}
        <div className='col-span-4 text-center'>
        <h3 className="text-skin-base text-base text-center lg:text-[17px] lg:leading-7 font-medium mb-4 sm:mb-5 lg:mb-6 pb-0.5">Contact us</h3>
        <div>
<a href="tel:01093942104">
01093942104
</a>   
- <a href="tel:01016257613">
01016257613
</a>
<br />
<a href="tel:01114545799">
01114545799
</a> - <a href="tel:01112073657">
01112073657
</a> - <a href="tel:01026060560">
01026060560
</a>
</div>
        </div>
